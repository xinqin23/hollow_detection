"""
DINOv2 classification on Overwatch frames (original and hollow contour).
...
def run_experiment(variant):
    print(f"\n{'='*60}")
    print(f"DINO Experiment: Overwatch {variant}")
    print(f"{'='*60}")
    ...
    out_path = RESULTS_DIR / f"dino_overwatch_{variant}.json"
